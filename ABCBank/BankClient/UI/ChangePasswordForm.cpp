...
ChangePasswordForm::ChangePasswordForm(SHORT x,SHORT y,SHORT w,SHORT h, const std::string& title)
:JForm(x,y,w,h),title_(title)
{
	lblAccountId_ = new JLable(14, 5, 11, 1, "ACCOUNT ID:", this);
	editAccountId_ = new JEdit(26, 5, 21, 1, "", this);
	lblAccountIdTip_ = new JLable(50, 5, 11, 1, "长度6位，数字", this);
	...
	lblNewPass_ = new JLable(12, 11, 13, 1, "NEW PASSWORD:", this);
	editNewPass_ = new JEdit(26, 11, 21, 1, "", this, JEdit::EM_PASSWORD);
	lblNewPassTip_ = new JLable(50, 11, 11, 1, "长度6-8位", this);


	lblNewPass2_ = new JLable(9, 14, 16, 1, "REPEAT PASSWORD:", this);
	editNewPass2_ = new JEdit(26, 14, 21, 1, "", this, JEdit::EM_PASSWORD);
	lblNewPass2Tip_ = new JLable(50, 14, 7, 1, "同上", this);
