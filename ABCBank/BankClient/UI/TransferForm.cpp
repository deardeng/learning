	  ...
	  title_(title)
{
	...
	lblMoney_ = new JLable(19, 11, 12, 1, "MONEY:", this);
	editMoney_ = new JEdit(26, 11, 21, 1, "", this);
	lblMoneyTip_ = new JLable(50, 11, 15, 1, "小数最多两位", this);

	lblAccountId2_ = new JLable(11, 14, 14, 1, "TO ACCOUNT ID:", this);
	editOtherAccountId_ = new JEdit(26, 14, 21, 1, "", this);
	lblAccountId2Tip_ = new JLable(50, 14, 11, 1, "长度6位，数字", this);
