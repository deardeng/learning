...
#define low16(x) ((x) & 0xFFFF)
    ...
    class Idea{
        ...
        void IdeaCfbDecrypt(struct IdeaCfbContext *ctx,unsigned char const *src,unsigned char* dest,int count);
        public:
        void Crypt(unsigned char const key[16],unsigned char const* src,unsigned char* dest,int count,bool encrypt);
    };
}
