...
int system_init(const char* config_file_name,List<pUSR_ACCOUNT>& user,List<pUSR_INFOR>& student,USR_ACCOUNT_NUM &usr_account_num,USR_INFOR_NUM &usr_infor_num){
    ...
    if(!f2){
        ...
        while(f2 >> nodeu->usr_name >> nodeu->usr_pwd >> nodeu->usr_role){
            //f2 >> node->usr_name >> node->usr_pwd >> node->usr_role;
            user.push_back(nodeu);
            nodeu=new USR_ACCOUNT;
        }
        //f2.read(buf,sizeof(buf));
        //string temp(buf);
        //cout << temp << endl;
        ...
        //word.clear();
        //while(word){
        //    pUSR_ACCOUNT node=new USR_ACCOUNT;
        //    cout << word << endl;
        //    word >> node->usr_name >> node->usr_pwd >> node->usr_role;
        //    cout << node->usr_name  << ' ' << node->usr_pwd  << ' ' << node->usr_role << endl;
        //    user.push_back(node);
        //}
    }
    cout << "ok" << endl;
    ...
    //static USR_ACCOUNT root={"deng","dx",true};
    //static USR_ACCOUNT user1={"deng","dx",true};
    //static USR_ACCOUNT user2={"deng","dx",true};
    //user.push_back(&root);
    //user.push_back(&user1);
    //user.push_back(&user2);
    //static USR_INFOR a={1,"dx",1,99};
    //static USR_INFOR b={1,"dxx",1,98};
    //static USR_INFOR c={1,"dxxx",1,97};
    //student.push_back(&a);
    //student.push_back(&b);
    //student.push_back(&c);
    //usr_account_num = user.size();
    //cout << "*********************" << endl;
    //cout << usr_account_num << endl;
    //cout << "*********************" << endl;
