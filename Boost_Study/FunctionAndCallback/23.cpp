...
int main()
{
    ...
    boost::signals::connection c1 = sig.connect(0, slots<10>());
    boost::signals::connection c2 = sig.connect(0, slots<20>());
    boost::signals::connection c3 = sig.connect(1, slots<30>());
